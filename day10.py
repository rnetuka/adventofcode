...
# notice something metallic scurry away in your peripheral vision and jump into a big pipe! It didn't look like any
...
if __name__ == '__main__':
    ...
    print('How many steps along the loop does it take to get from the starting position to the point farthest from the '
          'starting position?')
    print(solution_1())
    print('--- Part Two ---')
